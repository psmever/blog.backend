 ...
 */
     ...
     */ 
         ...
         * @static 
         */ 
        public static function ErrorMacro($message = null, $errors = null, $statusCode = 400)
        {
                        return \Illuminate\Routing\ResponseFactory::ErrorMacro($message, $errors, $statusCode);
        }

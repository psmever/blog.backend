...
class PostsRepository implements PostsRepositoryInterface
{
     ...
     * @var PostsThumbs
     */
    protected PostsThumbs $PostsThumbs;

    /**
     * PostsRepository constructor.
     * @param Posts $posts
     * @param PostsTags $poststags
     * @param MediaFiles $mediafiles
     * @param PostsThumbs $poststhumbs
     */
...
//    public function getAllData() {}
     ...
     * @return object|null
     */
    public function createPostsThums(array $dataObject = []) : ?object
    {

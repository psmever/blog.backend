...
class ScribbleCreateTest extends TestCase
{
    ...
    public function test_scribble_create_끄적끄적_로그인_하지_않은_상태에서_요청할때()
    {
    ...
    public function test_scribble_create_끄적끄적_제목_없을때()
    {
        $testBody = '{
            "title":"",
            "contents" : {
    ...
    public function test_scribble_create_끄적끄적_본문_없을때()
    {
        $testBody = '{
    ...
    public function test_scribble_create_끄적끄적_정상_요청()
    {
        $testBody = '{
            "title":"테스트 포스트 입니다.",
            "contents" : {

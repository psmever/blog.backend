...
class MingunCreateTest extends TestCase
{
    ...
    public function test_mingun_post_create_라우터_오류()
    {
...
//        $response->dump();
    ...
    public function test_mingun_post_create_로그인_하지_않은_상태에서_요청할때()
    {
        $response = $this->withHeaders($this->getTestApiHeaders())->json('POST', '/api/v1/section-post/mingun');
//        $response->dump();
    ...
    public function test_mingun_post_create_제목_없을때()
    {
        $testBody = '{
            "title":"",
            "contents" : {
        ...
        $response = $this->withHeaders($this->getTestAccessTokenHeader())->json('POST', '/api/v1/section-post/mingun', json_decode($testBody, true));
//         $response->dump();
    ...
    public function test_mingun_post_create_본문_없을때()
    {
        $testBody = '{
    ...
    public function test_mingun_post_create_정상_요청()
    {
        $testBody = '{
            "title":"테스트 포스트 입니다.",
            "contents" : {

...
class ScribbleViewTest extends TestCase
{
    ...
    public function test_scribble_post_view_라우터_오류()
    {
...
//        $response->dump();
    ...
    public function test_scribble_post_view_데이터_없을때()
    {
        $response = $this->withHeaders($this->getTestAccessTokenHeader())->json('GET', "/api/v1/section-post/scribble", []);
//        $response->dump();
        $response->assertStatus(404);
        $response->assertJsonStructure([
            'error' => [
    ...
    public function test_scribble_post_view_정상_요청()
    {
